...
public class WaitElementFw {
	...
	public static void visibilityOfElementLocated(WebDriver driver, By by) { //AppObject
		WebDriverWait wait = new WebDriverWait(driver, TIMEOUT_SEC);
		wait.until(ExpectedConditions.visibilityOfElementLocated(by));
	}
	
	public static void visibilityOf(WebDriver driver, WebElement element) {//Task
		WebDriverWait wait = new WebDriverWait(driver, TIMEOUT_SEC);
